...
const About = () => {
  return (
    <section className="flex items-center bg-orange-100 h-screen font-poppins dark:bg-gray-800 ">
      <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
        <div className="flex flex-wrap items-center ">
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="lg:max-w-md">
              <span className="text-xl font-semibold text-orange-600 uppercase dark:text-orange-500">
                About Us
              </span>
          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="flex mb-4">
              <span className="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-6 bg-orange-500 rounded dark:bg-orange-500 dark:text-gray-100 text-gray-50">
                <svg
